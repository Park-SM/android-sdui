...
@Deprecated("Don't use it because it was for testing purposes.")
class FakeProductDelegator @Inject constructor(
    ...
    private fun getProduct333(): ProductDetailDTO {
    ...
    private fun getProduct555(): ProductDetailDTO {
        return ProductDetailDTO(
            id = 555L,
    ...
    private fun getProduct777(): ProductDetailDTO {
        return ProductDetailDTO(
            id = 777L,
    ...
    private fun getProduct999(): ProductDetailDTO {
        return ProductDetailDTO(
            id = 999L,
    ...
    private fun getProduct121(): ProductDetailDTO {
        return ProductDetailDTO(
            id = 121L,
    ...
    private fun getProduct131(): ProductDetailDTO {
        return ProductDetailDTO(
            id = 131L,
    ...
    private fun getProduct141(): ProductDetailDTO {
        return ProductDetailDTO(
            id = 141L,
    ...
    private fun getProduct151(): ProductDetailDTO {
        return ProductDetailDTO(
            id = 151L,
